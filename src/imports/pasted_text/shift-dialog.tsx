...
import { X, Check, XCircle, Edit, Save } from 'lucide-react';
          ...
          <div>
            ...
            <div className="space-y-3">
              {currentAvailabilities.map((availability) => {
                const canEdit = availability.status === 'pending' && (!currentUser.isManager ? availability.employeeId === currentUser.id : true);
                const canDelete = availability.status === 'pending' && (!currentUser.isManager ? availability.employeeId === currentUser.id : true);
                    ...
                    {editingId === availability.id ? (
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-semibold">{statusLabels[availability.status]}</span>
